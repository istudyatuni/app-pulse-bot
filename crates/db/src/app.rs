...
impl DB {
    pub async fn get_app(&self, app_id: AppId) -> Result<Option<models::App>> {
    ...
    pub async fn save_app_last_updated_at(&self, app_id: AppId, last_updated_at: UnixDateTime) -> Result<()> {
    ...
    pub async fn add_app(&self, source_id: SourceId, name: &str) -> Result<AppId> {
    ...
    /// to this source
    pub async fn get_apps_to_check_updates(&self, source_id: SourceId) -> Result<Vec<models::App>> {
